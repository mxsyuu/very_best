class DishesController < ApplicationController
  ...
  def index
    ...
    @dishes = @q.result(distinct: true).includes(:user, :favorite_dishes,
                                                 :cuisine, :venues).page(params[:page]).per(10)
  end
  ...
  def dish_params
    params.require(:dish).permit(:venue_id, :item, :cuisine_id, :description,
                                 :user_id)
  end
end
